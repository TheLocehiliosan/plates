      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            ...
            substrings — log each find as you reach that target. For elements, if
            you need Be then B, plate <strong>BET123</strong> contains both{' '}
            <strong>BE</strong> and <strong>B</strong> — the app records both
            automatically when you log Be.
          </li>
          <li>
...
function getExample(id: string): string {
  switch (id) {
    ...
    case 'elements':
      return 'When seeking HE, plate THE-999 qualifies. HE must appear as one substring — not H from one part of the plate and E from another.';
    case 'pi':
